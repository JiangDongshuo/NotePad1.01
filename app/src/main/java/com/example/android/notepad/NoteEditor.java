...
public class NoteEditor extends Activity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        View noteEditor=(View)findViewById(R.id.note);
        switch (item.getItemId()) {
            ...
            case R.id.color_white:
                //System.out.println("choose white");
                noteEditor.setBackgroundColor(Color.WHITE);
                break;
            case R.id.color_gray:
                //System.out.println("choose gray");
                noteEditor.setBackgroundColor(Color.GRAY);
                break;
            case R.id.color_blue:
                //System.out.println("choose blue");
                noteEditor.setBackgroundColor(Color.BLUE);
                break;
            case R.id.color_yellow:
                noteEditor.setBackgroundColor(Color.YELLOW);
                break;
            case R.id.color_red:
                noteEditor.setBackgroundColor(Color.RED);
                break;
            case R.id.export:
